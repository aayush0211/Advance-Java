...
public class User {
	...
	//first_name,last_name,email,pass,dob,status
	public User(String firstName, String lastName,String email,String pass, Date dob, boolean votingStatus,String role) {
		super();
		this.firstName = firstName;
		this.lastName = lastName;
		this.email=email;
