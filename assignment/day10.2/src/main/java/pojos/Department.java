...
public class Department extends BaseEntity {
	...
	// Dept 1--->* Emps
	@OneToMany(mappedBy = "myDept") // mandatory o.w : hib throws MappingExc.
	//mappedBy for insert foreign key in table - use on nonowning(inverse) side
	private List<Employee> employees = new ArrayList<>(); //for bidirectional
