...
public class CandidateDaoImpl implements CandidateDao {
	...
	public CandidateDaoImpl() throws SQLException {
		...
		pst5 = cn.prepareStatement("insert into candidates values(default,?,?,?)");
	...
	@Override
	public int addCandidate(Candidate newCandidate) throws SQLException {
		pst5.setString(1, newCandidate.getCandidateName());
		pst5.setString(2, newCandidate.getParty());
		pst5.setInt(3, newCandidate.getVotes());
		return pst5.executeUpdate();
