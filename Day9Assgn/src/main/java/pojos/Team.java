...
public class Team {
	...
	@Column(length = 100)						// serializable
	private String name;
	@Column(length = 10)
	...
	@Column(name = "max_age")
	private int maxAge; // it will not be mandatory to be in Ingeter as only Primary Key should be Serializable 
	@Column(name = "batting_avg")
	private double minBattingAvg;
	@Column(name = "wickets_taken")
	private int minWicketsTaken;

	public Team() {  //mandatory
